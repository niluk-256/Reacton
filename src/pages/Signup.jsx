      ...
      <div className="flex flex-wrap mb-8">
        ...
        <div className="w-full md:w-[67%] ml-4 mr-4 lg:w-[40%] lg:mt-10">
          ...
          <form onSubmit={onsubmit}>
            <div>
              <input
                className="border-2 transition duration-500 placeholder-gray-500 focus:placeholder-transparent border-blue-400 w-full py-2  text-black-400 bg-transparent rounded-md focus:outline-none text-left md:p mb-4"
                type="text"
                id="name"
                value={name}
                onChange={onChange}
