...
<div className="flex flex-wrap mb-8">
  ...
  <form >
    <div>
      <p className="mb-4 font-semibold">To reset your password enter your email address we'll send you instructions
      </p>
    <input className="mb-4 border-2 transition duration-500 placeholder-blue-200 focus:placeholder-transparent border-blue-400 w-full py-2  text-black-400 bg-transparent rounded-md focus:outline-none text-left md:p" type="email" id='email' value={email}onChange={onChange} placeholder="email address"/>
    </div>
   
    
    <button className="w-full bg-blue-600 text-white px-7 py-3 rounded-lg shadow-md
  hover:bg-blue-700 transition duration-150 ease-in-out hover:shadow-lg" type="submit">Send Email</button>
